...
export default function OfferForm({ form, updateField, onRun, loading }) {
  return (
    <section className="card glass">
      <div className="cardHeader">
        <h2 className="cardTitle">Profile</h2>
        <div className="cardHint">Enter your offer details for AI analysis</div>
      </div>
      ...
      <div className="row2">
        ...
        <label className="toggleBlock">
          ...
          <div>
            ...
            <div className="toggleDesc">Factor in systemic pay disparities</div>
          </div>
        </label>
      </div>

      {/* MODIFIED: Button now calls onRun and shows loading state */}
      <button 
        className="runBtn" 
        type="button" 
        onClick={onRun} 
